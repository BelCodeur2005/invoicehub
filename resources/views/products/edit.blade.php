...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-600">Modifiez les informations du produit "{{ $product->name }}"</p>
        </div>
            ...
            <form action="{{ route('products.update', $product) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description"
                              ...
                              placeholder="Description détaillée du produit ou service...">{{ old('description', $product->description) }}</textarea>
                    @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
