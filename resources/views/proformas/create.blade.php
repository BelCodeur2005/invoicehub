...
@section('page-title', 'Créer un Nouveau Proforma')
@section('content')
<div class="space-y-6">
    <!-- Header -->
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Nouveau Proforma</h1>
            <p class="mt-2 text-sm text-gray-600">Créez un nouveau proforma pour vos clients</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="p-6">
            <form action="{{ route('proformas.store') }}" method="POST" class="space-y-6" x-data="proformaForm()">
                @csrf
                ...
                <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                    <a href="{{ route('proformas.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg transition-colors">
                        Annuler
                    </a>
